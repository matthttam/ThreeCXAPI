...
class TestTCX_API_Connection:
    ...
    def test_make_request_with_expired_token(self, mock_response):
        ...
        with patch.object(api_connection, "_is_token_expired", return_value=True), \
             patch.object(api_connection, "_refresh_access_token") as mock_refresh:
    ...
    def test_make_request_without_expired_token(self, mock_response):
        ...
        # Perform call where _is_token_expired is False and mock _refresh_access_token
        with patch.object(api_connection, "_is_token_expired", return_value=False), \
             patch.object(api_connection, "_refresh_access_token") as mock_refresh:
            response = api_connection._make_request(method, endpoint, **other_argument)
    ...
    @patch("threecxapi.tcx_api_connection.time")
